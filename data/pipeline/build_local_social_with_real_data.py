...
def build_connectivity():
    ...
    mobile = create_descriptive_dimension(
        ...
        snapshot=Snapshot(value=81.0, unit="% of landmass", year=2025, date="July 2025"),
        source=Source(
    ...
    digital_exclusion = create_descriptive_dimension(
        ...
        snapshot=Snapshot(value=2.5, unit="out of 10 (0 = lowest risk, 10 = highest)", year=2021, date="DERI v1.5"),
        source=Source(
